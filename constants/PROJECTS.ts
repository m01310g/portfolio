...
export const PROJECTS: Project[] = [
  {
    ...
    screenshots: [
      { src: "/project1/login.png", caption: "로그인 화면" },
      { src: "/project1/signup.png", caption: "회원가입 화면" },
      {
        src: "/project1/main.png",
        caption: "홈 화면 – 소설 연재 내역 및 전체 소설 조회",
      },
      {
        src: "/project1/novel.png",
        caption: "소설 상세 페이지 – 작가 소개 및 소설 에피소드 조회",
      },
      {
        src: "/project1/community.png",
        caption: "커뮤니티 – 창작자의 소통 공간",
      },
      {
        src: "/project1/mypage.png",
        caption: "마이페이지 – 정보 수정 및 연재/활동 내역 조회",
      },
      {
        src: "/project1/admin.png",
  ...
  },
  {
    ...
    **'마이킹(Myking)'**은 사용자가 지역 기반으로 **산 정보를 손쉽게 확인하고, 함께 등산을 즐길 메이트를 모집하거나 참여**할 수 있는 플랫폼입니다.`,
    ...
    screenshots: [
      { src: "/project2/main.png", caption: "홈 화면 - 산 및 등산 파티 조회" },
      {
        src: "/project2/mountain.png",
        caption: "산 상세 화면 - 산 및 코스 정보 조회",
      },
      {
        src: "/project2/parties.png",
        caption: "등산 파티 화면 - 등록된 파티 정보 등록 및 조회",
      },
      {
        src: "/project2/mypage.png",
        caption:
          "마이페이지 - 사용자 정보 조회, 수정 및 등록하거나 참여한 파티 관리",
      },
      {
        src: "/project2/admin.png",
  ...
  },
  {
    ...
    * _배포 완료했지만 현재 DB 사용량이 초과되어 서버가 닫힌 상태입니다._`,
    ...
    screenshots: [
      { src: "/project3/community.png", caption: "거래 게시글 목록 화면" },
      {
        src: "/project3/community-detail.png",
        caption: "거래 게시글 상세 화면 - 게시글 수정, 삭제 및 거래 정보 확인",
      },
      { src: "/project3/chatting-list.png", caption: "참여한 채팅 목록" },
      { src: "/project3/chatting.png", caption: "실시간 채팅 화면" },
      {
        src: "/project3/chatting-status.png",
  ...
  },
  {
    ...
    screenshots: [
      { src: "/project4/main.png", caption: "메인 화면 - 자기 소개" },
      { src: "/project4/skills.png", caption: "기술 스택 섹션" },
      { src: "/project4/projects.png", caption: "프로젝트 목록 섹션" },
      {
        src: "/project4/project-modal.png",
        caption:
          "개별 프로젝트 모달 - 사용한 기술 스택, 기능, 기여도, 스크린샷 확인 가능",
      },
      {
        src: "/project4/about.png",
